package ExampleIO::Schema::Result::Person;

use base 'ExampleIO::Schema::Result';
...
__PACKAGE__->might_have(
  profile =>
  'ExampleIO::Schema::Result::Profile',
  { 'foreign.person_id' => 'self.id' }
);

__PACKAGE__->has_many(
  credit_cards =>
  'ExampleIO::Schema::Result::CreditCard',
  { 'foreign.person_id' => 'self.id' }
);

__PACKAGE__->has_many(
  person_roles =>
  'ExampleIO::Schema::Result::PersonRole',
  { 'foreign.person_id' => 'self.id' }
);
