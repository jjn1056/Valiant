...
__PACKAGE__->validates(person_roles => (presence=>1, ResultSet=>1, set_size=>{min=>1}, on=>'min'));
__PACKAGE__->validates(roles => (presence=>1, ResultSet=>1, set_size=>{min=>1}, on=>'min'));
