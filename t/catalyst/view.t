...
{
  ok my $res = request '/form';
  is $res->content, '<form accept-charset="UTF-8" class="new_view_example_view_hello" enctype="application/x-www-form-urlencoded" id="new_view_example_view_hello" method="post"><input id="view_example_view_hello_name" name="view_example_view_hello.name" type="text" value="John"/></form>';
}
