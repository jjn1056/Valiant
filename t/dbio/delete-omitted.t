...
#
# Three parent classes share the same physical 'artist'/'album' tables (see
# t/dbio/nested-options.t for the precedent): ArtistAD (allow_destroy only),
# ArtistDO (delete_omitted only), ArtistBoth (both).  A fourth, ArtistDOCode,
# covers delete_omitted as a coderef.
