package DBIO::Valiant::Util::Exception::TooManyRows;
...
DBIO::Valiant::Util::Exception - More rows attempted than you are permitted to create

=head1 SYNOPSIS

     DBIO::Valiant::Util::Exception->throw(msg=>'validations argument in unsupported format');
