package DBIO::Valiant::Result::HTML::FormFields;
...
This module extends DBIO to provide functionality for mapping database fields to HTML form fields. It allows for easy generation and handling of form elements based on the schema's result class.
